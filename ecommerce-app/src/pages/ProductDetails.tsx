...
function ProductDetails() {
    // used for retrieving route parameters
    ...
    const fetchProductInfo = async () => {
        try {
            const { data } = await axios.get('http://localhost:3000/products/' + params.productId);
            setProductInfo(data);
        } catch(error) {
            setProductInfo(null);
        } finally {
    ...
    if (loading) {
        return (
            <div className="container py-5 text-center">
                ...
                <p className="nt-2 text-muted">Loading product...</p>
            </div>
        );
    }
            ...
            <div className="row g-4 align-items-start">
                ...
                <div className="col-12 col-md-7 col-lg-8">
                    ...
                    <ul className="nav justify-content-center mt-4">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to={'rating-reviews'}>Ratings & Reviews</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to={'question-answers'}>Question & Answers</Link>
                        </li>
                    </ul>
                    <Outlet/>
                </div>
