...
function Employees() {
    const [employees, setEmployees] = useState([
        ...
        { id: 103, name: "Arjun Reddy", role: "Backend Developer", department: "Engineering", salary: 82000, location: "Chennai" },
        { id: 104, name: "Priya Singh", role: "HR Manager", department: "HR", salary: 60000, location: "Mumbai" },
        { id: 105, name: "Vikas Das", role: "DevOps Engineer", department: "Infrastructure", salary: 90000, location: "Pune" },
        { id: 106, name: "Anita Joshi", role: "UI/UX Designer", department: "Design", salary: 78000, location: "Delhi" },
