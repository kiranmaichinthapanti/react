...
function Profile() {
    ...
    return (
        <div className= "my-5">
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <h5>City: <span style={cityStyles}>Hyderabad</span></h5>
            </div>

            <i className={`fa-solid ${!isPasswordVisible ? `fa-eye-slash text-danger` : `fa-eye text-success`} fs-3`}></i>
            
            <h3>Address: <span className="address">2nd Floor, Digital Edify, Madhapur, Hyderabad</span></h3>
